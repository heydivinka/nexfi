...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .swal2-popup.nexfi-alert .swal2-title {
    ...
    .swal2-popup.nexfi-alert .swal2-html-container {
    ...
    .swal2-popup.nexfi-alert .swal2-icon.swal2-success {
      border-color: rgba(108,99,255,0.4) !important;
      color: #6c63ff !important;
    }
    .swal2-popup.nexfi-alert .swal2-icon.swal2-success .swal2-success-ring {
      border-color: rgba(108,99,255,0.2) !important;
    }
    .swal2-popup.nexfi-alert .swal2-icon.swal2-success [class^='swal2-success-line'] {
      background-color: #6c63ff !important;
    }
    .swal2-popup.nexfi-alert .swal2-icon.swal2-warning {
      border-color: rgba(245,158,11,0.5) !important;
      color: #f59e0b !important;
    }
    .swal2-popup.nexfi-alert .swal2-icon.swal2-error {
      border-color: rgba(239,68,68,0.4) !important;
    }
    .swal2-popup.nexfi-alert .swal2-icon.swal2-error [class^='swal2-x-mark-line'] {
      background-color: #ef4444 !important;
    }

    .swal2-popup.nexfi-alert .swal2-actions {
      margin-top: 24px !important;
      gap: 10px !important;
    }

    .swal2-popup.nexfi-alert .swal2-confirm {
    ...
    .swal2-popup.nexfi-alert .swal2-confirm:hover {
      opacity: 0.88 !important;
      transform: translateY(-1px) !important;
    }

    .swal2-popup.nexfi-alert .swal2-cancel {
    ...
    .swal2-popup.nexfi-alert .swal2-timer-progress-bar {
      background: linear-gradient(90deg, #6c63ff, #9b59f5) !important;
    ...
    /* icon glow success */
    .swal2-popup.nexfi-alert .swal2-icon.swal2-success::before {
    ...
    .yt-play div {
      width:68px; height:68px; border-radius:50%; background:#dc2626;
    ...
    .modal-content { background:#1a1a2e; margin:5% auto; padding:10px; width:90%; max-width:700px; border-radius:12px; border:1px solid var(--border); }
    .close { float:right; font-size:28px; cursor:pointer; color:#fff; line-height:1; padding:4px 8px; }
    ...
    #aboutSection {
      ...
      background:linear-gradient(180deg,#07080f 0%,#0c0d1d 100%); z-index:1;
    }
    ...
    .btn-kirim {
      ...
      color:#fff; font-weight:700; padding:14px; border-radius:16px; border:none; cursor:pointer;
      font-size:0.875rem; font-family:'Inter',sans-serif;
      background:linear-gradient(135deg,var(--accent),var(--accent2));
      box-shadow:0 10px 30px var(--glow); transition:opacity 0.2s,transform 0.2s; width:100%;
    }
...
<div id="videoModal" class="modal">
  <div class="modal-content">
    ...
    <iframe id="youtubeFrame" width="100%" height="400" src="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
  </div>
</div>
...
function nexIcon(type) {
  ...
  return `<div style="width:64px;height:64px;border-radius:50%;background:${m.bg};display:flex;align-items:center;justify-content:center;margin:0 auto 4px;">
    <i class="fa-solid ${m.icon}" style="font-size:1.75rem;color:${m.color};"></i>
  </div>`;
}
...
function submitTesti(btn) {
  ...
  if (!nama || !email || !isi || selectedRating === 0) {
    showAlert({
      ...
      html: 'Mohon isi semua field dan pilih <strong style="color:#fbbf24;">rating bintang</strong> terlebih dahulu ya.',
      confirmText: 'Siap, isi dulu! ✍️'
    });
    return;
  }
  ...
  fetch('{{ route("testimonial.store") }}', { method: 'POST', body: data })
    ...
    .then(function(res) {
      if (res.success) {
        showAlert({
          type: 'success',
          title: 'Terima Kasih! 🎉',
          html: 'Terima kasih atas testimoni Anda mengenai website kami.<br><br>'
              + '<span style="color:rgba(255,255,255,0.4);font-size:0.82rem;">'
              + 'Kami akan menyaring konten terlebih dahulu sebelum mempublish testimoni Anda. Tunggu sebentar ya!'
              + '</span>',
          confirmText: 'Oke, siap! 👍',
          timer: 7000
        });
        /* reset form */
        form.querySelectorAll('input[name="nama"], input[name="email"], textarea[name="isi"]').forEach(function(el){ el.value = ''; });
        selectedRating = 0;
        paintStars(0);
        ...
        showAlert({
          ...
          html: 'Maaf, testimoni kamu gagal terkirim. Silakan coba lagi.',
    ...
    .catch(function() {
      showAlert({
        type: 'error',
        title: 'Server Error',
        html: 'Terjadi kesalahan pada server. Mohon coba beberapa saat lagi.',
        confirmText: 'Tutup'
      });
      btn.disabled = false;
      btn.innerHTML = orig;
...
function handleSubmitKoran(btn) {
  ...
  if (!name || !email || !subject || !message) {
    showAlert({
      type: 'warning',
      title: 'Form belum lengkap!',
      html: 'Mohon lengkapi semua field sebelum mengirim pesan.',
      confirmText: 'Oke, lengkapi dulu!'
    });
    return;
  }
  ...
  .then(function(res) {
    if (res.success) {
      showAlert({
        ...
        html: 'Terima kasih atas saran dan masukan Anda!<br><br>'
            + '<span style="color:rgba(255,255,255,0.4);font-size:0.82rem;">'
            + 'Tim kami akan segera meninjau dan menghubungi kamu melalui email yang terdaftar.'
            + '</span>',
        confirmText: 'Siap, terima kasih! 🙌',
        timer: 7000
      });
      form.reset();
    } else {
      showAlert({
        type: 'error',
        title: 'Gagal Mengirim',
        html: 'Pesan kamu gagal terkirim. Silakan coba lagi.',
        confirmText: 'Coba Lagi'
      });
    }
    btn.disabled = false;
  ...
  .catch(function(err) {
    ...
    showAlert({
      type: 'error',
      title: 'Server Error',
      html: 'Terjadi kesalahan. Mohon coba beberapa saat lagi.',
      confirmText: 'Tutup'
    });
    btn.disabled = false;
    btn.innerHTML = btnText;
...
(function() {
  ...
  track.addEventListener('touchend',   function() {
    ...
    if (dragDelta < -60) goTo(current + 1); else if (dragDelta > 60) goTo(current - 1);
  });
...
document.querySelector('.close').onclick = function() { modal.style.display = 'none'; frame.src = ''; };
window.addEventListener('click', function(e) { if (e.target === modal) { modal.style.display = 'none'; frame.src = ''; } });
</script>
</body>
</html>